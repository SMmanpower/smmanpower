...
function Aboutus() {
  return (
    <>
    <section className="aboutus container lg:m-auto" id='aboutus'>
        <header className="p-2">
            <h2 className="text-center text-2xl lg:text-5xl aldrich-regular">
                About us
            </h2>
            <p className="text-sm lg:text-base inter text-justify lg:w-full m-auto px-2 py-2.5"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <main className="w-full lg:flex justify-center items-center text-4xl px-2.5 gap-2.5">
            <aside className="mission lg:w-1/2 p-2.5">
            ...
            <aside className="vission lg:w-1/2 p-2.5">
