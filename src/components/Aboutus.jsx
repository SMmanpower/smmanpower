...
function Aboutus() {
  return (
    <>
    <section className="aboutus container py-4 m-auto lg:m-auto" id='about'>
        ...
        <main className="w-full lg:flex justify-center items-center text-4xl px-2.5 lg:gap-2.5">
            <aside className="mission lg:w-1/2 px-1 lg:p-2.5">
            ...
            <aside className="vission lg:w-1/2 px-1 lg:p-2.5">
