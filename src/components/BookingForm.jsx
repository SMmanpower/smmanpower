...
function BookingForm() {
  ...
  return (
    ...
    <section className="continer m-auto lg:px-8" id='booking'>
        ...
        <form action="" onSubmit={handleSubmit} className="w-400 h-fit lg:w-auto  grid grid-cols-1 grid-rows-12 lg:grid-cols-2 lg:grid-rows-6 grid-flow-col border-2 border-black rounded-lg lg:rounded-3xl m-auto  gap-0 lg:gap-0 items-center justify-center place-items-center">
