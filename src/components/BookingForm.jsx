...
function BookingForm() {
  ...
  return (
    ...
    <section className="container w-full m-auto sm:px-8" id='booking'>
        ...
        <form action="" onSubmit={handleSubmit} className="w-85 h-fit pb-5 sm:pl-5 sm:h-auto sm:w-auto grid grid-cols-1 grid-rows-12 sm:grid-cols-2 sm:grid-rows-6 grid-flow-col border-2 border-black rounded-2xl sm:rounded-3xl m-auto  sm:gap-0 items-end justify-center place-items-center">
