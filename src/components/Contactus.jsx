...
function Contactus() {
  return (
    ...
    <section className="contactus container m-auto p-4 xl:px-8 xl:py-4" id='contactus'>
        ...
        <main className="w-full flex justify-center items-center flex-wrap xl:flex-nowrap mt-5">
            <div className="w-1/2 xl:w-1/4 flex gap-2.5 xl:gap-5 justify-center items-center xl:border-r-black xl:border-r-4 xl:my-4">
            ...
            <div className="w-1/2 xl:w-1/4 flex gap-2.5 xl:gap-5 justify-center items-center xl:px-4 xl:border-r-black xl:border-r-4 xl:my-4">
            ...
            <div className="w-1/2 xl:w-1/4 flex gap-2.5 xl:gap-5 justify-center items-center xl:px-4 ">
