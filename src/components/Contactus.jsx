...
function Contactus() {
  return (
    <>
    <section className="contactus container m-auto p-4 lg:px-8 lg:py-4" id='contactus'>
        ...
        <main className="w-full flex justify-center items-center flex-wrap lg:flex-nowrap mt-5">
            <div className="w-1/2 lg:w-1/4 flex gap-2.5 lg:gap-5 justify-center items-center lg:border-r-black lg:border-r-4 lg:my-4">
                ...
                <p className="aldrich-regular text-xl lg:text-4xl lg:px-4">
                    Clients <br />
            ...
            <div className="w-1/2 lg:w-1/4 flex gap-2.5 lg:gap-5 justify-center items-center lg:px-4 lg:border-r-black lg:border-r-4 lg:my-4">
                ...
                <p className="aldrich-regular text-xl lg:text-4xl">
                    Staffs <br />
            ...
            <div className="w-1/2 lg:w-1/4 flex gap-2.5 lg:gap-5 justify-center items-center lg:px-4 lg:border-r-black lg:border-r-4 lg:my-4">
                ...
                <p className="aldrich-regular lg:text-4xl text-xl">
                    Talents <br />
