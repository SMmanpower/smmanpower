...
function Contactus() {
  return (
    ...
    <section className="contactus container m-auto p-4 lg:px-8 lg:py-4" id='contact'>
        ...
        <main className="w-11/12 m-auto lg:w-full flex justify-center items-center flex-wrap lg:flex-nowrap mt-5">
            <div className="w-1/2 lg:w-1/4 flex gap-2.5 lg:gap-5 lg:justify-center items-center lg:border-r-black lg:border-r-4 lg:my-4">
            ...
            <div className="w-1/2 lg:w-1/4 flex gap-2.5 lg:gap-5 lg:justify-center items-center lg:px-4 lg:border-r-black lg:border-r-4 lg:my-4">
            ...
            <div className="w-1/2 lg:w-1/4 flex gap-2.5 lg:gap-5 lg:justify-center items-center lg:px-4 ">
