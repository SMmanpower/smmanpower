  ...
  return (
    ...
    <section className="contactus container m-auto p-4 sm:px-8 sm:py-4" id='contact'>
        ...
        <main className="w-11/12 m-auto sm:w-full flex justify-center items-center flex-wrap sm:flex-nowrap mt-5">
            <div className="w-1/2 sm:w-1/3 flex gap-2.5 sm:gap-5 sm:justify-center items-center sm:border-r-black sm:border-r-4 sm:my-4">
            ...
            <div className="w-1/2 sm:w-1/3 flex gap-2.5 sm:gap-5 sm:justify-center items-center sm:px-4 sm:border-r-black sm:border-r-4 sm:my-4">
            ...
            <div className="w-1/2 sm:w-1/3 flex gap-2.5 sm:gap-5 sm:justify-center items-center sm:px-4 sm:my-4">
