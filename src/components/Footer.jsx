...
function Footer() {
  ...
  return (
    <>
    <section className="w-full bg-footer pt-4 lg:h-400 lg:py-5">
        <button onClick={togglePopup} className=" wallpoet-regular text-3xl text-center lg:text-5xl lg:text-left ml-10 lg:mt-2.5">
            SM Manpower
        </button>
        ...
        <footer className="lg:flex justify-center items-center p-2 lg:px-10 lg:py-4 gap-5">
            <div className="box lg:w-1/3 lg:p-4 lg:border-r-4 border-black">
                <p className="aldrich-regular text-2xl lg:text-3xl text-left w-60 lg:w-300 m-auto lg:mt-1.5">Email</p>
                <li className='w-60 lg:w-300 m-auto list-none'>
                    <a href="mailto:manpowerservicessm@gmail.com" className="inter text-lg lg:text-xl w-200 m-auto">manpowerservicessm@gmail.com</a>
                </li>
                <p className="aldrich-regular text-2xl lg:text-3xl text-left w-60 lg:w-300 m-auto lg:mt-1.5">Phone No</p>
                <li className="w-60 lg:w-300 m-auto list-none">
                    <a href="tel:+917867993525" className="inter text-lg lg:text-xl text-left lg:w-300 m-auto">+91 7867993525</a>
                </li>
                <p className="aldrich-regular text-2xl lg:text-3xl text-left w-60 lg:w-300 m-auto mt-1.5">Adderss</p>
                <p className="inter w-60 lg:w-300 m-auto text-lg lg:text-xl text-left">
            ...
            <div className="box lg:w-1/3 lg:h-200 m-auto">
    ...
    {isPopupOpen && (
            <section className="w-4/5 p-2.5 lg:w-600 h-fit fixed lg:p-10 bg-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-3/4 border-2 rounded-3xl border-primary ">
                <h2 className="aldrich-regular text-center text-primary text-3xl">
                    Welcome admin
                        <button onClick={togglePopup} className='w-8 h-18 lg:w-12 lg:h-12 float-end lg:top-2.5'>
                            <img src={close} alt="" />
                        </button>
                </h2>
